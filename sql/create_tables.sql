...
CREATE TABLE listmanialists (
  listmanialist_id VARCHAR(36) NOT NULL,
  name VARCHAR(255) NOT NULL,
...
CREATE TABLE shopaddresses (
  shopaddress_id VARCHAR(36) NOT NULL,
  shops_shop_id VARCHAR(36) NOT NULL,
...
CREATE TABLE priceinfos (
  priceinfo_id VARCHAR(36) NOT NULL,
...
CREATE TABLE userreviews (
  userreview_id VARCHAR(36) NOT NULL,
  products_asin VARCHAR(10) NOT NULL,
...
CREATE TABLE guestreviews (
  guestreview_id VARCHAR(36) NOT NULL,
  products_asin VARCHAR(10) NOT NULL,
  rating INTEGER NOT NULL,
  helpful_votes INTEGER NOT NULL,
  summary TEXT NOT NULL,
...
CREATE TABLE purchases (
  ...
  products_asin VARCHAR(10) NOT NULL,
  priceinfos_priceinfo_id VARCHAR(36) NOT NULL,
  users_username VARCHAR(30) NOT NULL,
...
CREATE TABLE deliveryaddresses (
  deliveryaddress_id VARCHAR(36) NOT NULL,
  street VARCHAR(255) NOT NULL,
...
CREATE TABLE audiotexts (
  audiotext_id VARCHAR(36) NOT NULL,
...
CREATE TABLE dvdformats (
  dvdformat_id VARCHAR(36) NOT NULL,
  name VARCHAR(255) NOT NULL,
...
CREATE TABLE junction_books_authors (
  ...
  authors_author_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_books_publishers (
  books_asin VARCHAR(10) NOT NULL,
  publishers_publisher_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_dvds_actors (
  ...
  actors_actor_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_dvds_studios (
  dvds_asin VARCHAR(10) NOT NULL,
  studios_studio_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_dvds_audiotexts (
  dvds_asin VARCHAR(10) NOT NULL,
  audiotexts_audiotext_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_dvds_dvdformats (
  dvds_asin VARCHAR(10) NOT NULL,
  dvdformats_dvdformat_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_products_categories (
  products_asin VARCHAR(10) NOT NULL,
  categories_category_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_products_listmanialists (
  products_asin VARCHAR(10) NOT NULL,
  listmanialists_listmanialist_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_products_creators (
  products_asin VARCHAR(10) NOT NULL,
  creators_creator_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_products_artists (
  products_asin VARCHAR(10) NOT NULL,
  artists_artist_id VARCHAR(36) NOT NULL,
...
CREATE TABLE junction_users_deliveryaddresses (
  users_username VARCHAR(30) NOT NULL,
  deliveryaddresses_deliveryaddress_id VARCHAR(36) NOT NULL,
